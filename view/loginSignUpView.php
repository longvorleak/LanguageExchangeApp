...
<div class="container" id="container">
    <div class="form-container sign-up-container">
        ...
        <form action=<?= BASE . "/index.php?action=signUp" ?> method="POST">
            ...
            <input type="text" name="username" placeholder="Username*" maxlength="50" id="username-signup" />
            ...
            <input type="password" name="passwordConfirm" placeholder="Confirm password*" /> <input type="submit" class="sign-button" value="Sign up" />
        </form>
    </div>
