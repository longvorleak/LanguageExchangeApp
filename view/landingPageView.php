...
<section class="section even">
    <div class="section-img">
        <img src="./public/images/langEx2.png" alt="splash" title="splash" class="splash-img" />
    </div>
    <div class="section-text">
...
<section class="section odd">
    ...
    <div class="section-img">
        <img src="./public/images/undraw_Chatting_re_j55r.png" alt="splash" title="splash" class="splash-img" />
    </div>
</section>
<!-- SECTION 6 -->
<section class="section even">
    <div class="section-img">
        <img src="./public/images/langEx3.png" alt="splash" title="splash" class="splash-img" />
    </div>
    <div class="section-text">
...
<section class="section odd center">
    ...
    <div class="section-box">
        <div class="section-card">
            <img src="https://i.pravatar.cc/70?img=<?= rand(1, 70) ?>" class="profile-rating" />
            <p>蝴元室友個象衣果可得丟。麼再手新泉行，不已身用吧向斗蛋誰未金水很冬壯士朋它南雨？正飯鼻棵結吃，車發相太山乞、過身路六急兌南流，過消聽了這過它交我信封原訴您。</p>
        ...
        <div class="section-card">
            <img src="https://i.pravatar.cc/70?img=<?= rand(1, 70) ?>" class="profile-rating" />
            <p>汗晚流抄眼福丁尤。牠幫氣見原哪冒男珠，植工秋力至世跑未笑能快知胡尼工事陽：陽支吃住麼黃想吧身采；士只兒再跳。</p>
            <span class="fa fa-star checked"></span>
            <span class="fa fa-star checked"></span>
            <span class="fa fa-star checked"></span>
            <span class="fa fa-star checked"></span>
        ...
        <div class="section-card">
            <img src="https://i.pravatar.cc/70?img=<?= rand(1, 70) ?>" class="profile-rating" />
            <p>師筆衣流卜反斤戊冒哥找這呢幫笑讀九至法！直父跟很戊元室每種公羊東女四親前老何京澡。土乍鼻尾穴色想但且個拍拍免幾物信星、綠老合同吹學葉氣。貓登門流反且牠反開珠幼因荷校公今「每爸女古步員固美」和裏。</p>
            <span class="fa fa-star checked"></span>
            <span class="fa fa-star checked"></span>
            <span class="fa fa-star checked"></span>
            <span class="fa fa-star checked"></span>
        ...
        <div class="section-card">
            <img src="https://i.pravatar.cc/70?img=<?= rand(1, 70) ?>" class="profile-rating" />
            <p>虎開比十面綠筆方直問。杯白母爪衣愛星服記到喝，早蝶樹民安子秋兩抱只能黃時蛋兄都！書牙澡故更是冰冰，巾假太首各寫乞話吹首免媽元孝斗足四聲兆免民。</p>
            <span class="fa fa-star checked"></span>
            <span class="fa fa-star checked"></span>
            <span class="fa fa-star checked"></span>
            <span class="fa fa-star checked"></span>
